...
from dataloader_scripts.train_dataloader import LowDosePETData
...
def main():
    os.environ['OPENAI_LOGDIR'] = "./models/saved_model/"  # set the logdir
    ...
    while True:
        ...
        training_data = LowDosePETData(num_slices=num_slices)
